...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        KC_DEL,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LEFT,           KC_RGHT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS,
        ...
        KC_LSFT, LALT_T(KC_Z),KC_X,KC_C,    KC_V,    KC_B,                                KC_N,    KC_M,    KC_COMM, KC_DOT,  RGUI_T(KC_SLSH), KC_RSFT,
    LT(SYMB,KC_GRV),WEBUSB_PAIR,A(KC_LSFT),KC_LEFT, KC_RGHT,  KC_BSPC,                  KC_ESC,    KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, MO(SYMB),
                                      LSFT_T(KC_TAB),KC_LGUI,LCTL_T(KC_BSPC),    RALT_T(KC_ENT), KC_RCTL,RSFT_T(KC_SPC)
    ),
