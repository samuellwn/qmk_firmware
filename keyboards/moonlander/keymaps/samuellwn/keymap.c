...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        KC_DEL,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LEFT,           KC_RGHT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
    ...
    [SYMB] = LAYOUT_moonlander(
        ...
        EE_CLR,  _______, _______, _______, _______,          _______,           _______,          _______, KC_0,    KC_DOT,  KC_EQL,  _______,
